...
```{r bingocardblank, echo = F, fig.cap="Ruth's selected bingo card!", fig.id="bingoblank", out.width = "100%"}
...
```{r evaporationvid, echo = F, fig.cap="See how the snowmelt runs off the rocks at the base of Las Torres. It's unable to penetrate into the granite, so it runs off instead. ", warning=F, fig.align='center'}
library(voice)
