...
```{r infiltrationexcess, echo = F, fig.cap="See how the snowmelt runs off the rocks at the base of Las Torres. It's unable to penetrate into the granite, so it runs off instead. "}
...
```{r evaporation, echo = F, fig.cap="The power of the wind can be seen in the clouds it was whipping up and the waves on the shoreline. Both of these processes will result in higher surface area on the water droplets and evaporation. "}
