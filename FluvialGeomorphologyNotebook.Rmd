...
```{r evaporation, echo = F, fig.cap="See how the snowmelt runs off the rocks at the base of Las Torres. It's unable to penetrate into the granite, so it runs off instead. "}
