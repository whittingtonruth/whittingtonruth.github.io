...
```{r bankerosion20032004, fig.show='hold', fig.cap='Bank Erosion from 2003 to 2004. See the DEM from 2003 (left), 2004 (middle), and the change detected (right). The polygon used to perform the analysis is shown in black. ', out.width="33%", echo=F}
...
My example of Bank Erosion in this year was another, slightly larger section (340 m^2) of bank that shifted slightly to the left. Total volume removed was 318±79 cubic meters. Average depth of lowering was 0.99 m, demonstrating the larger magnitude of bed and bank shifts during this time compared with the 2003-2004 timeframe. See the comparison in the images below (Fig. \@ref(fig:bankerosion20042005)). 

```{r bankerosion20052004, fig.show='hold', fig.cap='Bank Erosion from 2004 to 2005. See the DEM from 2004 (left), 2005 (middle), and the change detected (right). The polygon used to perform the analysis is shown in black. ', out.width="33%", echo=F}
...
```{r bankerosionflowdirection, fig.show='hold', fig.cap='The change in flow direction between 2004 and 2005 is shown using the blue arros', out.width="30%", echo=F}
...
```{r channelincision20042003, fig.show='hold', fig.cap='Channel incision from 2003 to 2004. See the DEM from 2003 (left), 2004 (middle), and the change detected (right). The polygon used to perform the analysis is shown in black. ', out.width="33%", echo=F}
...
```{r channelincision20042003hist,fig.cap='Histogram of the volume change from 2003 to 2004 in this section of channel incision. Note the peak of volume loss at a comparatively low elevation loss.', out.width="60%", echo=F}
...
```{r channelaggradation20042003, fig.show='hold', fig.cap='Channel aggradation from 2003 to 2004. See the DEM from 2003 (left), 2004 (middle), and the change detected (right). The polygon used to perform the analysis is shown in black. ', out.width="33%", echo=F}
...
```{r channelaggradationzoomout, fig.show='hold', fig.cap='See how this particular polygon is on the periphery, and is not accompanied by an adjacent channel degradation. ', out.width="60%", echo=F}
knitr::include_graphics("./images/Module7/ChannelAggradation_2003Pre.jpg")
```
