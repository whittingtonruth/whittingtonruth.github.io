...
```{r flowseparation, echo = F, fig.cap="This area is much simpler than the main reach I looked at. Here is the most likely place to find uniform flow. ", out.width="70%", fig.align='center'}
...
```{r flowtypes, echo = F, fig.cap="So many flow types could be seen in this one stretch of stream. ", out.width="100%", fig.align='center'}
...
```{r flowtypes3, echo = F, fig.cap="Downstream were more areas of rippled and smooth surface flow. ", out.width="100%", fig.align='center'}
